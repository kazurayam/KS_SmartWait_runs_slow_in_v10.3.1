            ...
            for (var index in window.katalonWaiter.ajaxObjects) {
              ...
              if (isPromise) {
                ...
                if ((requestI.readyState) !== 4
				  ...
				  && (requestI.reCheckCount === undefined || requestI.reCheckCount < 100)
                ) {
                	if (requestI.readyState === 1) {
                  		requestI.reCheckCount = requestI.reCheckCount == undefined ? 1 : requestI.reCheckCount + 1;
				  	}
				  	return false;
                }
              }
